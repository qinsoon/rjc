...
public class ConstantDefinitionUsePass extends CompilationPass {
    DefaultDirectedGraph<Value, DefaultEdge> defUse = new DefaultDirectedGraph<Value, DefaultEdge>(DefaultEdge.class);
